package com.mekanismbiggerteleporter.client;

import com.mekanismbiggerteleporter.MekanismBiggerTeleporter;
import com.mekanismbiggerteleporter.network.ClientPacketDispatcher;
...
@Mod.EventBusSubscriber(modid = MekanismBiggerTeleporter.MOD_ID, value = Dist.CLIENT, bus = Mod.EventBusSubscriber.Bus.MOD)
